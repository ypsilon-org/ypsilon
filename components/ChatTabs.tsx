          ...
          <aside className="chat-sidebar">
            ...
            <nav className="sidebar-nav">
              ...
              {loadingUnits ? (
                ...
                units.map((unit) => {
                  const color = UNIT_COLORS[unit.name] ?? "#C8A84B";
                  const numeral = UNIT_NUMERALS[unit.name] ?? "";
                  return (
                    <button
                      key={unit.id}
            ...
            {unitId && unitName && (
              <>
                ...
                <button
                  ...
                  style={
                    {
                      "--tab-color": UNIT_COLORS[unitName] ?? "#C8A84B",
                ...
                >
                  <span
                    className="nav-btn-indicator"
                    style={{ background: UNIT_COLORS[unitName] ?? "#C8A84B" }}
                  />
                  <span className="nav-btn-label">{unitName}</span>
                  <span
                    className="nav-btn-numeral"
                    style={{ color: UNIT_COLORS[unitName] ?? "#C8A84B" }}
                  >
                    {UNIT_NUMERALS[unitName] ?? ""}
                  </span>
                </button>
                <div className="sidebar-divider" />
              </>
