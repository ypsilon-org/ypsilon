    ...
    <div className="ow-root">
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .units-overview{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:1px;background:rgba(200,168,75,.08);border:1px solid rgba(200,168,75,.08);}
        ...
        .unit-block-stats{display:flex;gap:1.5rem;flex-wrap:wrap;}
        ...
        <div className="ow-stack">
          ...
          <div className="stats-grid">
            {[
              ...
              },
              {
                ...
                sub: "awaiting leader assignment",
                accent: unassignedCount > 0,
              },
              {
                label: "Pending Verdict",
                value: pendingCount,
                sub: "awaiting leader approval",
              ...
              <div className="stat-card" key={s.label}>
                <div
                  ...
                  style={{
                    background: s.accent
                      ? "linear-gradient(to right,#E07070,transparent)"
                ...
                <p
                  ...
                  style={{ color: s.accent ? "#E07070" : "var(--bone)" }}
                >
                  {s.value}
                </p>
          ...
          <div className="panel">
            ...
            <div className="panel-body">
              <p className="section-eyebrow">Godfather's Decree</p>
              ...
              >
                Orders dispatched here will appear in the unit leader's command
                page. The leader must then assign it to a specific soldier.
              </p>
              <GodmodeTaskForm
          ...
          {unassignedTasks.length > 0 && (
            <div className="panel">
              ...
              />
              <div className="panel-body">
                <p className="section-eyebrow">Awaiting Leader Assignment</p>
            ...
            <div className="panel-body">
              ...
              <div className="units-overview">
                {units?.map((unit) => {
                  ...
                  const unass = tasks.filter((t) => t.status === "unassigned");
          ...
          <div className="panel">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right,rgba(200,168,75,.5),transparent)",
              }}
            />
            <div className="panel-body">
          ...
          <div className="panel">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right,rgba(200,168,75,.3),transparent)",
              }}
            />
            <div className="panel-body">
              ...
              {allTasks && allTasks.length > 0 ? (
                ...
                <p className="task-empty">No missions issued yet.</p>
              )}
            </div>
          </div>
