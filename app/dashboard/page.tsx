...
const STATUS_CONFIG = {
  ...
  pending_approval: { label: "Awaiting Approval", color: "#A6FF00" },
  completed: { label: "Completed", color: "#6FF3FF" },
  rejected: { label: "Returned", color: "#FF6A00" },
};
          ...
          <div className="rank-card">
            ...
            <div className="rank-card-grid">
              <div>
                ...
                <div className="rank-bar-track">
                  <div
                    ...
                    style={{
                      width: `${progressPct}%`,
                      background: `linear-gradient(to right,${unitColors.primary},${unitColors.primary}55)`,
                    }}
                  />
                </div>
              ...
              <div className="rank-pts-block">
                <p className="rank-pts-value">{totalPoints.toLocaleString()}</p>
                <p className="rank-pts-label">Total Points</p>
              </div>
            </div>
          </div>
          ...
          {profile?.unit_name && (
            <div className="stats-grid">
              ...
              <div className="stat-card">
                ...
                />
                <p className="stat-label">Missions Done</p>
                <p className="stat-value" style={{ color: unitColors.text }}>
            ...
            <div className="panel">
              ...
              <div className="panel-body">
                ...
                <div className="task-list">
                  {[...activeTasks, ...rejectedTasks].map((task) => {
                    const sc =
                      ...
                      <div key={task.id} className="task-row">
                        ...
                        <div>
                          ...
                          <div className="task-meta">
                            ...
                            <span className="task-from">
                              from @{task.created_by_username}
                            </span>
                            {task.status === "rejected" && (
                              <span className="task-returned-note">
          ...
          {completedTasks.length > 0 && (
            <div className="panel">
              ...
              <div
                className="panel-top-bar"
                style={{
                  background: "linear-gradient(to right,#6FF3FF33,transparent)",
                }}
              />
              <div className="panel-body">
          ...
          {(!tasks || tasks.length === 0) && (
            <div className="panel">
              ...
              <div
                className="panel-top-bar"
                style={{
                  background: `linear-gradient(to right,${unitColors.primary}44,transparent)`,
                }}
              />
              <div className="panel-body">
                <p className="section-eyebrow">Your Orders</p>
